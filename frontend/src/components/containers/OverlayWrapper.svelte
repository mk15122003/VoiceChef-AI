<script>
  ...
  const handleKeypress = (e, payload) => {
    if (e.key === 'Enter' || e.key === ' ') {
      handleClickOnScreen(payload);
    }
  };
</script>
...
<style lang="scss">
  ...
  .select-recipe-btn:focus, .select-recipe-btn:hover { outline: none; transform: translateY(-4px); box-shadow: 0 16px 30px rgba(0,0,0,0.12)}
  ...
  .select-btn:focus, .select-btn:hover { transform: scale(1.05); outline: none; box-shadow: 0 8px 20px rgba(0,0,0,0.08); }
  ...
  .next-btn:focus, .next-btn:hover { transform: translateY(-2px); outline: none }
  ...
  .prev-btn:focus, .prev-btn:hover { transform: translateY(-2px); outline: none }
  ...
  .cancel-btn:focus, .cancel-btn:hover { transform: translateY(-2px); outline: none }
  ...
  .scale-btn {
    ...
    &:focus, &:hover { transform: translateY(-3px); outline: none; box-shadow: 0 8px 16px rgba(0,0,0,0.06) }
  }
  ...
  .modal-continue-btn:focus, .modal-continue-btn:hover { transform: translateY(-2px); outline: none }
  .modal-letsgo-btn {
    position: absolute;
    bottom: 21%;
    z-index: 100;
  ...
  .modal-letsgo-btn:focus, .modal-letsgo-btn:hover { transform: translateY(-2px); outline: none }
